---
title: "Assisted Use in the Confocal Microscopy Facility, FY2018"
output:
  html_document:
    df_print: paged
...
Go to the iLab reporting section and follow the steps below.

Just select the default charts -- they won't be used.

```{r pressure, echo=FALSE, fig.cap="Exporting FY18 data from iLab", out.width = '60%'}
knitr::include_graphics("./2018-07 FY18usage export.png")
```

For this period, the output file is called `07012017_06302018_charges_report_source_data.csv`.
...
datafile <- "07012017_06302018_charges_report_source_data.csv"
