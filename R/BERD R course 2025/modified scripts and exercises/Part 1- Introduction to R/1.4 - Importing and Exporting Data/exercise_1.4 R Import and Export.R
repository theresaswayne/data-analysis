...
setwd("/Users/theresaswayne/Desktop/BERD R course/course_files_export/Part 1- Introduction to R/1.4 - Importing and Exporting Data/Exercises")
practice_data <- read.csv("trashwheel2014.csv")

# Question 2: Export 'practice_data' to an xlsx file and name it 'my_data'

write.csv(practice_data, "my_data.xlsx")
